...
class Lexer {
    ...
    isIdentifier (){
        return constants.REGEX.identRegExp;
    }
    ...
    isDigit (digitChar) {
        return constants.REGEX.intRegExp;
    }
    ...
    readString () {
        const stringEnd = constants.SYMBOLS.STRING_QUOTE;
    ...
    readNext () {
        ...
        if (ch === constants.SYM.STRING_QUOTE) return this.readString();
